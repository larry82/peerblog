...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { content: @option.content, explanation: @option.explanation, question_id: @option.question_id, score: @option.score }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { content: @option.content, explanation: @option.explanation, question_id: @option.question_id, score: @option.score }
    assert_redirected_to option_path(assigns(:option))
  end
